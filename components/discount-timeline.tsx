...
import { Clock, Send, CheckCircle, XCircle, RefreshCw, FileText, Database, TrendingUp, GitBranch } from "lucide-react"
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="bg-slate-900 rounded p-2 max-h-32 overflow-y-auto">
                        <pre className="text-xs text-green-400 font-mono">{JSON.stringify(event.payload, null, 2)}</pre>
                      </div>
                    </div>
                  </div>
                )
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <pre className="bg-slate-900 text-green-400 p-4 rounded-lg text-sm font-mono overflow-auto max-h-64 shadow-inner">
